                ...
                <div class="col-lg-6">
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            <div class="item">
                                <img src="{{ asset('uploads/products') }}/{{ $product_info->thumbnail_photo }}" alt="">
                            </div>
                            
                            @foreach ($multiple_photos as $photos)
                            <div class="item">
                                <img src="{{ asset('uploads/product_multiple_photos') }}/{{ $photos->photo_name }}" alt="">
                            </div>    
                            @endforeach
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="featured-product-wrap">
                        <div class="featured-product-img">
                            <img src="{{ asset('uploads/products/') }}/{{ $related_product->thumbnail_photo }}" alt="">
                        </div>
                        <div class="featured-product-content">
                            <div class="row">
                                <div class="col-7">
                                    <h3><a href="{{ url('product/details') }}/{{ $related_product->id }}">{{ Str::limit($related_product->title, 50) }}</a></h3>
