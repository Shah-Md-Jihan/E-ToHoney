                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if (session('category_restore_status'))
                                    ...
                                    <div class="alert alert-success d-flex align-items-center" role="alert">
                                        <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
                                    <div>
                                      {{ session('category_restore_status') }}
                                    </div>
                                  </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <img src="{{ asset('uploads/categories') }}/{{ $category->category_photo }}" width="100px" alt="category image">
                                          </td>
                                          <td>{{ $category->created_at->diffForHumans() }}</td>
                                          <td>
                                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                <a href="{{ url('update/category') }}/{{ $category->id }}" type="button" class="btn btn-info">Edit</a>
                                                <a href="{{ url('delete') }}/{{ $category->id }}" type="button" class="btn btn-warning">Delete</a>
                                              </div>
                                          </td>
                                        </tr>
                        ...
                        <div class="card mt-5">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @forelse ( $deleted_categories as $delcategory )    
                                        <tr>
                                          <th scope="row">{{ $deleted_categories->firstItem() + $loop->index }}</th>
                                          <td>{{ $delcategory->category_name }}</td>
                                          <td>{{ $delcategory->deleted_at->diffForHumans() }}</td>
                                          <td>
                                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                <a href="{{ url('/restore/category') }}/{{ $delcategory->id }}" type="button" class="btn btn-success">Restore</a>
                                                <a href="{{ url('/hard/delete') }}/{{ $delcategory->id }}" type="button" class="btn btn-danger">Delete Permanently</a>
                                              </div>
                                          </td>
                                        </tr>
